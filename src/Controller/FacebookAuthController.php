...
class FacebookAuthController extends ControllerBase {
   ...
   */
  public function __construct(NetworkManager $network_manager, SocialAuthUserManager $user_manager, FacebookAuthManager $facebook_manager, FacebookAuthPersistentDataHandler $persistent_data_handler) {
  ...
  public function returnFromFb() {
    ...
    $user_info= SocialAuth::create([
        ...
        'user_id' => 2,
        'type' => 'facebook',
        'social_media_id' => $fb_profile->getField('id'),
    ]);
    $user_info->save();
